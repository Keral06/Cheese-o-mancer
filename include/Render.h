...
public:
	...
	bool DrawTextureScaled(SDL_Texture* texture, int x, int y, const SDL_Rect* section, float textureScale, float speed = 1.0f, double angle = 0.0, int pivotX = INT_MAX, int pivotY = INT_MAX, SDL_FlipMode flip = SDL_FLIP_NONE) const;
